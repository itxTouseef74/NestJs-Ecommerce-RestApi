...
export class AddTBLProducts1717093346314 implements MigrationInterface {
    name = 'AddTBLProducts1717093346314'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "categories" ADD "productsId" integer`);
